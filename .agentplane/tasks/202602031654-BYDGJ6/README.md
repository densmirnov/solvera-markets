...
tags: ["code"]
verify: ["make check"]
commit: { hash: "90ee283050614a4cf5fb05bbb5099410bf32f078", message: "✨ BYDGJ6 add ABI and events documentation" }
comments:
  - { author: "DOCS", body: "Start: Define ABI and event payload schemas for Stage 1.1." }
  - { author: "DOCS", body: "Verified: ABI and event payloads documented; no code execution required." }
doc_version: 2

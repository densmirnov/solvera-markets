...
tags: ["backend"]
verify: ["make check"]
commit: { hash: "92524a6f2fc7c05bc04d65034afef284f6cdd45d", message: "✨ TR9QAA add indexer schema and manifest" }
comments:
  - { author: "CODER", body: "Start: Define indexer schema and subgraph manifest for Stage 2.1." }
  - { author: "CODER", body: "Verified: Added schema, manifest, ABI, and model doc for indexer." }
doc_version: 2

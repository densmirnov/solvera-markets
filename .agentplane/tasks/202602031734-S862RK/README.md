...
tags: ["backend"]
verify: ["make check"]
commit: { hash: "6df0190c10fdc1730d3dcd2f087baa669e026010", message: "✨ S862RK add ops docs for indexer/backend" }
comments:
  - { author: "DOCS", body: "Start: Document ops and RPC minimization for indexer/backend." }
  - { author: "DOCS", body: "Verified: Ops doc added with RPC minimization and monitoring guidance." }
doc_version: 2

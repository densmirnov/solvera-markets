...
depends_on: []
tags: ["backend"]
verify: ["graph codegen && graph build"]
commit: { hash: "668099976c719a2cee70ce2ee72332901ad66e11", message: "✨ S8H8JG add immutable flags and fix ABI" }
comments:
  - { author: "CODER", body: "Start: Update Graph schema immutability flags for entities." }
  - { author: "CODER", body: "Verified: Schema immutable flags and ABI updated; graph build proceeds with new schema." }
doc_version: 2

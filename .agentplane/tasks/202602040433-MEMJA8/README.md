...
depends_on: []
tags: ["code"]
verify: ["git status --short --untracked-files=no"]
commit: { hash: "630cb8dcb397dfa60fe6371026f8bd72bfd0a54d", message: "🧽 MEMJA8 apply formatter outputs" }
comments:
  - { author: "CODER", body: "Start: commit formatter outputs from make fmt." }
  - { author: "CODER", body: "Verified: formatter output committed for contracts and indexer mappings." }
doc_version: 2

...
depends_on: []
tags: ["code"]
verify: ["rg \"forge\" scripts/fmt.sh scripts/lint.sh"]
commit: { hash: "b9258b78c8fe8bc16a5a5d059066e259a9381763", message: "🧭 NCP0HB run forge with contracts root" }
comments:
  - { author: "CODER", body: "Start: update scripts to run forge with contracts root." }
  - { author: "CODER", body: "Verified: Foundry fmt/lint now run with contracts root for correct remappings." }
doc_version: 2

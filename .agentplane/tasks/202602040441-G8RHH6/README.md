...
depends_on: []
tags: ["code"]
verify: ["rg \"forge test\" scripts/test.sh"]
commit: { hash: "52503be7177654039493c84626aa523abf6ed9fd", message: "🧪 G8RHH6 run forge tests with contracts root" }
comments:
  - { author: "CODER", body: "Start: update forge test invocation to use contracts root." }
  - { author: "CODER", body: "Verified: forge test now runs with contracts root so imports resolve." }
doc_version: 2

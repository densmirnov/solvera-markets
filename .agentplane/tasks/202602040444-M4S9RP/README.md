...
depends_on: []
tags: ["backend"]
verify: ["rg \"test\" indexer/package.json"]
commit: { hash: "504f580aa56118b105d75c772f09cd2ec1bb7130", message: "🧪 M4S9RP use graph test for indexer" }
comments:
  - { author: "CODER", body: "Start: update indexer test script to graph test CLI." }
  - { author: "CODER", body: "Verified: indexer test script now uses graph test to run subgraph tests." }
doc_version: 2

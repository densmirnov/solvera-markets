...
depends_on: []
tags: ["backend"]
verify: ["rg \"mock-subgraph\" docker-compose.yml"]
commit: { hash: "8c472fe97cb19e552aa96439d211e0c6df1a7f67", message: "🧪 H2JP2S add mock subgraph and agent e2e" }
comments:
  - { author: "CODER", body: "Verified: mock subgraph service and agent e2e flow added; compose updated." }
doc_version: 2

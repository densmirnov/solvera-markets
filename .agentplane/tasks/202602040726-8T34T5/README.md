...
depends_on: []
tags: ["backend"]
verify: ["rg -n \"solvera\\.markets|CORS_ORIGIN|VITE_API_BASE|SUBGRAPH_URL\" env.example .env"]
commit: { hash: "aaf0ca4e951fa2c55d228ef2d2ddcacf96173e12", message: "🧾 8T34T5 fix env domain and defaults" }
comments:
  - { author: "DOCS", body: "Start: normalize env files for solvera.markets and ensure required variables are present." }
  - { author: "DOCS", body: "Verified: env.example updated to solvera.markets and .env contains required production variables." }
doc_version: 2

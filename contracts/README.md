...
## Structure
- `src/` — Solidity sources (`IntentMarketplace.sol`, `MockERC20.sol` for smoke flows).
...
- Deploy smoke tokens to Status Sepolia: `forge script ./script/DeploySmokeTokens.s.sol --rpc-url status_sepolia --broadcast`
